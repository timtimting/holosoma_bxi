"""Locomotion curriculum presets for the Elf3 robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

elf3_29dof_curriculum = CurriculumManagerCfg(
    params={
...
elf3_29dof_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["elf3_29dof_curriculum", "elf3_29dof_curriculum_fast_sac"]
